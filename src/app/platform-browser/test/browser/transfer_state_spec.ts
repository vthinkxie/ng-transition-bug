...
import {BrowserModule, BrowserTransferStateModule, TransferState} from '@platform-browser';
import {StateKey, escapeHtml, makeStateKey, unescapeHtml} from '@platform-browser/src/browser/transfer_state';
