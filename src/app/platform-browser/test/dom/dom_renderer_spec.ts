...
import {NAMESPACE_URIS} from '@platform-browser/src/dom/dom_renderer';
import {browserDetection} from '@platform-browser/testing/src/browser_util';
import {expect} from '@platform-browser/testing/src/matchers';
