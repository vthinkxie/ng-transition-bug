...
import { ɵDomRendererFactory2 as DomRendererFactory2 } from "@platform-browser";
 ...
 * @publicApi
 */
export const ANIMATION_MODULE_TYPE = new InjectionToken<
  "NoopAnimations" | "BrowserAnimations"
>("AnimationModuleType");
